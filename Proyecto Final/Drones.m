...
while satF == 1 || satM == 1
   ...
   [sM, sF, iM, iF, fM, fF, satM, satF]=simulacion(nodesCoordinates, matrizDeCostos, mensajeros, fotografos, maximoMensajeria, maximoFotografia);
end

fprintf('Para suplir la demanda de %d misiones de fotografia, se necesitan %d drones fotografos \n', maximoFotografia, fotografos);
fprintf('Para suplir la demanda de %d misiones de mensajeria, se necesitan %d drones mensajeros \n', maximoMensajeria, mensajeros);