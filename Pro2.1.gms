...
nodo_origen_1(p)         Nodo origen 1
nodo_origen_2(p)          Nodo origen 2
nodo_origen_3(p)              Nodo origen 3
nodo_destino1(m)                 Nodo destino
nodo_intermedio1(m,p)          Nodo intermedio
nodo_intermedio2(m,p)            Nodo intermedio
nodo_intermedio3(m,p)            Nodo intermedio
...
nodo_origen_1(p)     ..      sum((j), x('n7',j,'n7',p)) =e= 1;
nodo_origen_2(p)     ..      sum((j), x('n2',j,'n2',p)) =e= 1;
nodo_origen_3(p)     ..      sum((j), x('n5',j,'n5',p)) =e= 1;
nodo_destino1(m)         ..      sum((i), x(i,'n6',m,'n6')) =e= 1;
nodo_intermedio1(m,p)    ..      sum((i,j), x(i,'n1',m,p)) - sum((i,j), x('n1',j,m,p)) =e= 0;
nodo_intermedio2(m,p)    ..      sum((i,j), x(i,'n3',m,p)) - sum((i,j), x('n3',j,m,p)) =e= 0;
nodo_intermedio3(m,p)    ..      sum((i,j), x(i,'n4',m,p)) - sum((i,j), x('n4',j,m,p)) =e= 0;
